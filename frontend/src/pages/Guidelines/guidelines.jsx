...
const AuthorGuidelines = () => {
    ...
    return (
        <div className="author-guidelines" style={{ padding: '20px' }}>
            <h3 className="text-center font-weight-bold">Author Guidelines and Responsibilities</h3>
            <div>
                <p>
                    <strong>Materials and Processing, </strong>
                    a journal by the ASM India National Council Trust (INC), invites submissions of original research articles, technical papers, reviews, case studies, and short communications that contribute to the understanding and advancement of engineering and manufacturing processes.
                    The journal aims to provide a platform for students, academicians, scholars, industrialists, researchers, and practitioners to share their latest findings, innovative ideas, and critical insights in the field of engineering and manufacturing processes.
                </p>
            </div>
