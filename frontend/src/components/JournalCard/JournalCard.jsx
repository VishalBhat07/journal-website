  ...
  return (
    <div className="journal-hero-container">
      ...
      <div className="journal-right-column">
        ...
        <h2 className="journal-subtitle">A journal from ASM India National Council Trust (INC)</h2>

        <div style={{ lineHeight: "1.2", marginBottom: "10px" }}>
          <p className="journal-data-headers"><strong>Year of Start:</strong> October 2023</p>
          <p className="journal-data-headers"><strong>Frequency:</strong> Biannually</p>
          <p className="journal-data-headers"><strong>Version:</strong> Electronic and Print</p>
          <p className="journal-data-headers"><strong>Subject:</strong> Education</p>
          <p className="journal-data-headers"><strong>Language of Publish:</strong> English</p>
        </div>
