    ...
    <div className={styles["journal-hero-container"]}>
      <div className={styles["journal-left-column"]}>
        ...
        <div className={styles["journal-contact-details"]}>
          ...
          <p className={styles["journal-contact-info"]}>
            Ajith Kumar: 9944452591
          </p>

          <h3 className={styles["journal-section-title"]}>
            Associate Editors:
          </h3>
          <p className={styles["journal-contact-info"]}>
      ...
      <div className={styles["journal-right-column"]}>
        ...
        >
          ...
          Trust (INC), is a biannual open access research journal featuring
          peer-reviewed original research articles, technical papers, reviews,
          case studies, and short communications contributing to the
